class CreateImportsSpi < ActiveRecord::Migration[8.1]
  def change
    create_table :imports_spi do |t|
    ...
    add_index :imports_spi, [ :azzonamento_di_riferimento_id, :anno_di_riferimento, :mese_di_riferimento ],
      name: "index_imports_spi_on_azzonamento_and_periodo"
    add_index :imports_spi, :codice_fiscale
  end
end
