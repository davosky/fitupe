class StatisticSpiPrintsController < ApplicationController
  ...
  def render_pdf
    return redirect_to statistic_spi_prints_path, alert: "Compila azzonamento, anno e mese" unless @total_members_form.valid?

    pdf = StatisticSpiPrints::ReportPdf.call(form: @total_members_form)
