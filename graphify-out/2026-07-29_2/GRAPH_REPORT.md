...
## Corpus Check
- 197 files · ~97,178 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1119 nodes · 1172 edges · 202 communities (110 shown, 92 thin omitted)
- Extraction: 91% EXTRACTED · 9% INFERRED · 0% AMBIGUOUS · INFERRED: 106 edges (avg confidence: 0.83)
...
8. `LegendsController` - 12 edges
9. `IntegrationFilleasController` - 12 edges
10. `IntegrationFlcsController` - 12 edges
...
## Communities (202 total, 92 thin omitted)
...
Cohesion: 0.16
Nodes (10): blocks(), blocks_for(), inline(), inline_node(), link_node(), list_blocks(), list_item_block(), blocks_for() (+2 more)
...
- **What is the exact relationship between `Devise.setup configuration (username auth)` and `Admin namespace routes (users)`?**
  _Edge tagged AMBIGUOUS (relation: conceptually_related_to) - confidence is low._
- **Why does `count()` connect `Community 185` to `Community 161`, `Community 130`, `Stack Tecnico (CLAUDE.md)`, `Community 137`, `Community 141`, `Community 187`, `Community 175`, `Community 80`, `Community 145`, `Community 183`, `Community 184`, `Community 153`, `Community 186`, `Community 155`?**
