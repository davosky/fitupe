...
## Corpus Check
- 199 files · ~97,542 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1129 nodes · 1183 edges · 197 communities (112 shown, 85 thin omitted)
...
## Communities (197 total, 85 thin omitted)
...
- **What is the exact relationship between `Devise.setup configuration (username auth)` and `Admin namespace routes (users)`?**
  _Edge tagged AMBIGUOUS (relation: conceptually_related_to) - confidence is low._
- **Why does `count()` connect `Community 80` to `Community 161`, `Community 130`, `Stack Tecnico (CLAUDE.md)`, `Community 137`, `Community 175`, `Community 145`, `Community 153`, `Community 155`?**
