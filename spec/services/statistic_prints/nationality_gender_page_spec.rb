...
RSpec.describe StatisticPrints::NationalityGenderPage do
  ...
  it "disegna le due colonne e i grafici a torta su un'unica pagina quando esistono dati" do
    create(:import, azzonamento_di_riferimento: zoning, anno_di_riferimento: "2025",
      mese_di_riferimento: "Giugno", sesso: "F", nazionalita: "ITALIA")
    create(:import, azzonamento_di_riferimento: zoning, anno_di_riferimento: "2026",
      mese_di_riferimento: "Giugno", sesso: "M", nazionalita: "EXTRAUE")
