...
RSpec.describe StatisticPrints::CategoriesPage do
  ...
  it "disegna la pagina senza errori quando esistono categorie con dati" do
  ...
  it "disegna un messaggio quando non ci sono categorie nel periodo" do
    create(:import, azzonamento_di_riferimento: zoning, anno_di_riferimento: "2025",
