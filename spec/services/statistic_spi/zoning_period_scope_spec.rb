...
RSpec.describe StatisticSpi::ZoningPeriodScope do
  subject(:scope) { described_class.call(zoning: zoning, anno: "2026", mese: "Giugno") }

  let(:zoning) { create(:zoning) }

  it "restituisce le importazioni SPI dell'azzonamento scelto quando esistono" do
    import_spi = create(:import_spi, azzonamento_di_riferimento: zoning, anno_di_riferimento: "2026",
    ...
    expect(scope).to contain_exactly(import_spi)
  end
  ...
  context "quando l'azzonamento scelto non ha importazioni dirette" do
    ...
    it "ricade sull'azzonamento superiore filtrando per codice_azzonamento_completo" do
      ...
      match = create(:import_spi, azzonamento_di_riferimento: regionale, anno_di_riferimento: "2026",
        mese_di_riferimento: "Giugno", codice_azzonamento_completo: "GB001")
      create(:import_spi, azzonamento_di_riferimento: regionale, anno_di_riferimento: "2026",
